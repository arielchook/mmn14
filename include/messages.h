...
#define WARN_LABEL_BEFORE_ENTRY "Warning:%d: label before .entry statement ignored\n"
#define WARN_LABEL_BEFORE_EXTERN "Warning:%d: label before .extern statement ignored\n"
...
#define ERR_NUM_OPERANDS "Error:%d: Incorrect number of operands for command (%s). Expecting %d operands\n"
...
#define ERR_FSEEK_FILE "Error: error seeking back to the beginning of input file (%s%s)\n"
